...
<section class="frontpage-hero-wrapper">
    <div class="frontpage-hero-img-left">
        <img alt="Under arbete med målerikonservering i Kalmar slott" src="<?php echo get_theme_file_uri('/images/konsult1.jpeg') ?>">
    </div>
    <div class="frontpage-hero-div-right">
        ...
        <div class="frontpage-hero-img-right">
            <img alt="Väggmålning föreställande Jesus i Lyngsjö kyrka" src="<?php echo get_theme_file_uri('/images/lyngsjo_kyrka.jpeg') ?>">
        </div>
    </div>
</section>
